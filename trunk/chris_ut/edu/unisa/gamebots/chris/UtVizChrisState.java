 ...
 */
public class UtVizChrisState extends UtVizJackInterface implements State{
    CurrentStateInstance currentStateInstance;
    Semaphore syncMutex = new Semaphore(1);
    
    /** Creates a new instance of UtChrisInterface */
    public UtVizChrisState(CurrentStateInstance currentStateInstance, Self self, Game game, Players players, Navs navs, Movs movs, Doms doms, Flags flags, Invs invs, AsyncMsgs async) {
