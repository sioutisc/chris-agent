 ...
 */
public class EnemyFlagFoundCursor extends Change {
    Self self;
    Flags flags;
    Actions actions;
    public EnemyFlagFoundCursor(Actions actions, Self self, Flags flags, boolean test) {
        super(actions,test);
    ...
    public boolean condition(){
        try{
            ...
            System.out.println("PATHFINDER: EnemyFlagFoundCursor: Error accessing the beliefset");
        }        
        return false;
    }
}
