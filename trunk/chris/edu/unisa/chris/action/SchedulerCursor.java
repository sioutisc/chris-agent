 ...
 */
public class SchedulerCursor extends Change {
    Scheduler scheduler;
    String target;
    ...
    public SchedulerCursor(Scheduler schedulerObject, String targetName, boolean test) {
    ...
    public boolean condition(){
        System.out.println(target+scheduler.getActiveTarget());
