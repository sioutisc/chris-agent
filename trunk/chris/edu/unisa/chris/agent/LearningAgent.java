 ...
 *   The base class of all agents. Specific agents are instances of subclasses derived from Agent.
 *   User defined agent classes (subclasses of Agent) will normally provide specialized definitions of the
 *   following three functions.
 *
 * @author  Christos Sioutis
 */
public abstract class LearningAgent extends Agent implements CHRISFunctions{
    int idCounter = 0;
 ...
 /*   public LearningAgent(String name, DecisionProcess process, Environment env){
        super(name);
    ...
    public LearningAgent(String name, String logLevels){
        super(name);
        ProgressMessage.messageCHRIS();
